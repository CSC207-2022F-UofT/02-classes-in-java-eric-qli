...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object
     * This constructor takes in two String as arguments.
     *
     * @param first_name a String for this Silly instance's first name
     * @param last_name a String for this Silly instance's last name
     */
    public Silly(String first_name, String last_name) {
